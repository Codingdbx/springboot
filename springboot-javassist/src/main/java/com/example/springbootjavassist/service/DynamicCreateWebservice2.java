 ...
 */
public class DynamicCreateWebservice2 {
    ...
    public static Class<?>  dynamicCreateWebservice() throws CannotCompileException, IOException {
        ...
        //类
        CtClass ctclass= classpool.makeClass("com.cesgroup.javassistWebservice.service.DynamicHelloWordWebservice2");

        classpool.importPackage("com.cesgroup.javassistWebservice.test");

        //添加方法
        CtMethod ctMethod = CtMethod.make("public String toSay(String str){\n" +
                "\n" +
        ...
        classAttr.addMemberValue("name", new StringMemberValue("dynamicCreate2",constPool));
        classAttr.addMemberValue("targetNamespace", new StringMemberValue("webservice2.soap.cesgroup.com", constPool));
        ...
        methodAttr.addMemberValue("operationName", new StringMemberValue("toSay", constPool));
        ...
        paramAnnotation.addMemberValue("name", new StringMemberValue("str",constPool));
        ...
        FileOutputStream fos = new FileOutputStream(new File("f:\\DynamicHelloWordWebservice2.class"));
        fos.write(bytes);
        fos.close();
    ...
    public static void main(String[] args) {
        ...
        try {
            Class<?> webservice = DynamicCreateWebservice2.dynamicCreateWebservice();
